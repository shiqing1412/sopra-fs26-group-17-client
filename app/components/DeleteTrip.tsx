  ...
  return (
    <Modal
      title={
        <div style={{ textAlign: "center", padding: "8px 0" }}>
          ...
          <div style={{ color: "#000", fontSize: 25, fontWeight: 600, marginTop: 8 }}>Delete this trip?</div>
        </div>
      }
      open={open}
      onCancel={onClose}
    ...
    >
      ...
      <div style={{ textAlign: "center", color: "#888", fontSize: 15, fontWeight: 400, marginTop: 12, marginBottom: 25 }}>
        The trip and all its events will be permanently deleted for all members.
      </div>
    </Modal>
  );
};
