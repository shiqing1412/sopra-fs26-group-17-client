  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable}`}>
        <ConfigProvider
          theme={{
            ...
            token: {
              ...
              colorPrimary: "#c0392b", // selected input field boarder will have this color as well
              borderRadius: 8,
              colorText: "#fff",
              fontSize: 16,
            ...
            components: {
              Button: {
                colorPrimary: "#c0392b", // this will color all buttons in #c0392b, overriding the default primaryColor set in token line 35
        ...
        <Script
          src={`https://maps.googleapis.com/maps/api/js?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}&libraries=places,marker&&language=en&region=US&loading=async`}
